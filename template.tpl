...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "webtru CMP(同意管理ツール)",
  ...
  "description": "webtruは国産シェアNo.1の同意管理ツールで、GDPR、個人情報保護法、電気通信事業法、CPRA等の規制やGoogle同意モードv2に簡単に対応することができます。詳しくは https://webtru.io/ をご覧ください。",
  "containerContexts": [
    "WEB"
  ]
}
